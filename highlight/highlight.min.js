...
endsParent:!0}]}]}}})());hljs.registerLanguage("python",(()=>{"use strict";function e(e){
...
begin:/^\.\.\.(?=[ ]|$)/}]}]})})());hljs.registerLanguage("fortran",(()=>{"use strict";function e(...e){
...
relevance:0},a,c]}}})());hljs.registerLanguage("c",(()=>{"use strict";function e(e){
...
strings:i,keywords:u}}}})());hljs.registerLanguage("php",(()=>{"use strict";return e=>{const r={
className:"variable",
...
contains:[a.SHEBANG({binary:"ruby"})].concat(E).concat(c).concat(_)}}})());hljs.registerLanguage("vbnet",(()=>{"use strict";function e(e){
return e?"string"==typeof e?e:e.source:null}function n(...n){
...
contains:[c]}]}}})());hljs.registerLanguage("bash",(()=>{"use strict";function e(...e){
...
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},b]}}})());hljs.registerLanguage("perl",(()=>{"use strict";function e(e){
return e?"string"==typeof e?e:e.source:null}function n(...n){
return n.map((n=>e(n))).join("")}function t(...n){return"("+((e=>{
const n=e[e.length-1]
;return"object"==typeof n&&n.constructor===Object?(e.splice(e.length-1,1),n):{}
...
contains:p}}})());hljs.registerLanguage("javascript",(()=>{"use strict"
...
begin:t,end:a,contains:[n],relevance:5}])}}})());hljs.registerLanguage("rust",(()=>{"use strict";function e(...e){
...
keyword:"Self",built_in:i}},{className:"punctuation",begin:"->"},n]}}})());hljs.registerLanguage("objectivec",(()=>{"use strict";return e=>{
...
relevance:0}]}}})());hljs.registerLanguage("r",(()=>{"use strict";function e(...e){return"("+((e=>{
const n=e[e.length-1]
;return"object"==typeof n&&n.constructor===Object?(e.splice(e.length-1,1),n):{}
})(e).capture?"":"?:")+e.map((e=>{return(n=e)?"string"==typeof n?n:n.source:null
;var n})).join("|")+")"}return n=>{
...
contains:[{begin:/\\./}]}]}}})());hljs.registerLanguage("shell",(()=>{"use strict";return s=>({
...
begin:"\\b("+e.join("|")+")\\b"}]};var s}})());hljs.registerLanguage("yaml",(()=>{"use strict";return e=>{
...
aliases:["yml"],contains:b}}})());hljs.registerLanguage("markdown",(()=>{"use strict";function n(...n){
...
className:"link",begin:/:\s*/,end:/$/,excludeBegin:!0}]}]}}})());hljs.registerLanguage("java",(()=>{"use strict"
...
begin:/[-+*/=%^~]|&&?|\|\|?|!=?|<(?:=>?|<|>)?|>[>=]?/,relevance:0}]}}})());hljs.registerLanguage("kotlin",(()=>{"use strict"
...
end:"$",illegal:"\n"},o]}}})());hljs.registerLanguage("cmake",(()=>{"use strict";return e=>({name:"CMake",
...
name:"Less",case_insensitive:!0,illegal:"[=>'/<($\"]",contains:c}}})());hljs.registerLanguage("ini",(()=>{"use strict";function e(e){
return e?"string"==typeof e?e:e.source:null}function n(...n){
